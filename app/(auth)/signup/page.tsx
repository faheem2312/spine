...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen md:h-screen flex flex-col md:flex-row bg-[#202020] overflow-y-auto">
      {/* Left Column - Signup Form (65% width on desktop) */}
      <div className="relative flex-1 flex flex-col items-center justify-center px-4 sm:px-6 md:px-12 lg:px-16 py-12 md:py-16 bg-[#202020]">
        ...
        <div className="w-full max-w-sm mt-8 md:mt-0">
          ...
          <div className="mb-8 text-center md:text-left">
            ...
            <p className="mt-1.5 text-sm text-white/70">
              Create an account to start your shelf. Enter your details below.
            </p>
          </div>
